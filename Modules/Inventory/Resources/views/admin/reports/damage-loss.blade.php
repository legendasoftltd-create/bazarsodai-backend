    ...
    <div class="card mb-3">
        <div class="card-body py-2">
            <form method="GET" class="row g-2 align-items-end">
                ...
                <div class="col-md-1">
                    <a href="{{ route('admin.inventory.reports.damage-loss') }}" class="btn btn-outline-secondary btn-block">{{ translate('Reset') }}</a>
                </div>
                <div class="col-md-1 text-right">
                    <a href="{{ route('admin.inventory.reports.export', 'damage-loss') }}?{{ http_build_query(request()->all()) }}" class="btn btn-outline-success btn-block">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-4">
            <div class="card text-center py-3">
                ...
                <p class="text-muted small mb-0">{{ translate('Total Records') }}</p>
            </div>
        </div>
    </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr><td colspan="8" class="text-center py-4">{{ translate('No damage/loss records found') }}</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
